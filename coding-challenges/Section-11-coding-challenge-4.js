...
console.log(dogs);
// Array(4)[{ … }, { … }, { … }, { … }]
// 0: Object { weight: 22, curFood: 250, recFood: 284, … }
// 1: Object { weight: 8, curFood: 200, recFood: 133, … }
// 2: Object { weight: 13, curFood: 275, recFood: 191, … }
// 3: Object { weight: 32, curFood: 340, recFood: 376, … }
// length: 4

// 2. Find Sarah's dog and log to the console whether it's eating too much or too little. HINT: Some dogs have multiple owners, so you first need to find Sarah in the owners array, and so this one is a bit tricky (on purpose) 
const dogSarah = dogs.find(dog => dog.owners.includes('Sarah'));
console.log(dogSarah);
console.log(`Sarah's dog is eating too ${dogSarah.curFood > dogSarah.recFood ? 'much' : 'little'}`); // Sarah's dog is eating too much

// 3. Create an array containing all owners of dogs who eat too much ('ownersEatTooMuch') and an array with all owners of dogs who eat too little ('ownersEatTooLittle').
const ownersEatTooMuch = dogs
    .filter(dog => dog.curFood > dog.recFood)
    .flatMap(dog => dog.owners);
console.log(ownersEatTooMuch); // Array(3) [ "Matilda", "Sarah", "John" ]

const ownersEatTooLittle = dogs
    .filter(dog => dog.curFood < dog.recFood)
    .flatMap(dog => dog.owners);
console.log(ownersEatTooLittle); // Array(3) [ "Alice", "Bob", "Michael" ]
...
console.log(dogs
    .some(checkEating)); // true

// 7. Create an array containing the dogs that are eating an OKAY amount of food (try to reuse the condition used in 6.)
console.log(dogs.filter(checkEating));
// Array [ {…} ]
// ​0: Object { weight: 32, curFood: 340, recFood: 376, … }
// ​​curFood: 340
// ​​owners: Array [ "Michael" ]
// ​​recFood: 376
// ​​weight: 32
// ​​<prototype>: Object { … }
// ​length: 1
...
// Array(4) [ {…}, {…}, {…}, {…} ]
// 0: Object { weight: 8, curFood: 200, recFood: 133, … }
// 1: Object { weight: 13, curFood: 275, recFood: 191, … }
// 2: Object { weight: 22, curFood: 250, recFood: 284, … }
// 3: Object { weight: 32, curFood: 340, recFood: 376, … }
// length: 4
